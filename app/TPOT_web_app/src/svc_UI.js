...
function SVCUI(props){
	return (
<div id="svc_UI" hidden>
...
<div className="ui_item">
	  ...
	  <div className="ui_item">
      <fieldset className="fieldset">
        <legend className="legend">probability</legend>
        <div className="input">
          <input type="checkbox" id="probability" value="False"></input>
        </div>
        <div className="description">
          <p className="type">Bool, default: False</p>
          <p>Whether to enable probability estimates.</p>
        </div>
      </fieldset>
      </div>
	...
	<div className="ui_item" >
      <fieldset className="fieldset">
        <legend className="legend">decision_function_shape</legend>
        <div className="ui_item">
		<select id="selector_kernel"> 
        ...
        <div className="description">
          <p className="type">Default: ovr</p>
          <p>Whether to return a one-vs-rest (‘ovr’) decision function 
		  as all other classifiers, or the original one-vs-one (‘ovo’) 
		  decision function of libsvm.</p>
        </div>
      </fieldset>
	</div>
	...
	<div className="ui_item">
      <fieldset className="fieldset">
        <legend className="legend">break_ties</legend>
        <div className="input">
          <input type="checkbox" id="break_ties" value="False"></input>
        </div>
        <div className="description">
          <p className="type">Bool, default: False</p>
          <p>If true, decision_function_shape='ovr', and number of classes is more than 2, 
		  predict will break ties according to the confidence values of decision_function; 
		  otherwise the first class among the tied classes is returned.</p>
        </div>
      </fieldset>
      </div>
